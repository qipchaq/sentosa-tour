...
//       <footer className="px-4 lg:container py-4 lg:py-5 m-auto">
//         <div className="divider"></div>
//         <div className="container grid gap-10 max-w-max md:grid-rows-1 md:grid-cols-4 lg:grid-rows-1 lg:gap-x-10">
//           <div className="flex flex-col gap-3 max-w-min">
//             <Link
//               href="#"
//               className="h-min inline-block text-primary-6000 focus:outline-none focus:ring-0 w-36"
//             >
//               <Image src={logo} alt="logo" width={130} height={25} />
//             </Link>
//             <div className="h-min flex items-center md:col-span-3">
//               <Link
//                 href="https://www.facebook.com/sentosa_tours"
//                 target="blank"
//                 className="mt-2 flex items-center gap-1"
